...
if (k1 == k2) {
    if (b1 == b2) {
        Console.Write("Two lines are the same. Infinite number of intersection points.");
    } else Console.Write("Two lines are parallel. No intersection points.");
} else {
    double x = (b1 - b2) / (k2 - k1);
    double y = k1 * x + b1;

    // Console.Write("b1 = " + b1 + ", k1 = " + k1 + ", b2 = " + b2 + ", k2 = " + k2 + " -> (" + x + "; " + y + ")");
    Console.Write("b1 = {0:f2}, k1 = {1:f2}, b2 = {2:f2}, k2 = {3:f2} -> ({4:f2}; {5:f2})", b1, k1, b2, k2, x, y);
}